import {
    Github, Sun, Search, CloudDrizzle, CloudRain, SunDim, CalendarDays, UserRound, Eye, Thermometer, Droplets, Gauge, Wind, Sunset, ThermometerSun, Navigation, Cloudy, CloudSun, Snowflake, Command
} from "lucide-react";
